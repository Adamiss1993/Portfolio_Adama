...
- Produire des **résultats cartographiques, analytiques et reproductibles**
...
- Traitements raster (pente, exposition, reclassification)
- Modélisation spatiale
- Automatisation de chaînes de traitements
...
- **Autres**
  - SIG raster et vectoriel  
  - Analyse multicritère spatiale  
...
- Sélections de zones répondant à des critères précis
- Scénarios comparatifs pour l’aide à la décision

Chaque projet dispose de son **README spécifique**, détaillant :
- le contexte,
...
- les résultats cartographiques et analytiques.
